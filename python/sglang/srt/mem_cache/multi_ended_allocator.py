...
class MultiEndedAllocator(BaseTokenToKVPoolAllocator):
    ...
    def __init__(
        ...
        *,
        ...
        # PD disaggregation: an in-flight RDMA transfer reads/writes PHYSICAL
        # pages outside any stream ordering, so `_flush` must not relocate while
        # this gate returns False.
